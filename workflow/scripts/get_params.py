...
def get_params(default_params, override_params):
    ...
    final_params = {key: None if value == 'null' else value for key, value in final_params.items()}
...
def main(default_params, override_params, output_file):
    ...
    default_params_fixed = default_params.replace("'", '"').replace('True', 'true').replace('False', 'false').replace('None', 'null')
    override_params_fixed = override_params.replace("'", '"').replace('True', 'true').replace('False', 'false').replace('None', 'null')
