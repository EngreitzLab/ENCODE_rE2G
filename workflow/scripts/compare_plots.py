...
def main(v1_dir, v2_dhs_dir, v2_dhs_hic_dir, output_file):
	...
	with PdfPages(output_file) as pdf_writer:
		pdf_writer.savefig(plot_enh_gene_links(v1_dir, v2_dhs_dir, v2_dhs_matching_ids, "E-G Links DHS Only"))
		pdf_writer.savefig(plot_enh_gene_links(v1_dir, v2_dhs_hic_dir, v2_dhs_hic_matching_ids, "E-G Links V1 DHS vs V2 DHS+HIC"))
